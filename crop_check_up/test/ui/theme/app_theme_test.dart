...
void main() {
  ...
  group('AppTheme', () {
    testWidgets('provides light and dark Material 3 themes', (WidgetTester tester) async {
    ...
    testWidgets('light theme uses SemanticColors.light for colorScheme', (WidgetTester tester) async {
    ...
    testWidgets('dark theme uses SemanticColors.dark for colorScheme', (WidgetTester tester) async {
    ...
    testWidgets('light theme defines TextTheme from AppTypography', (WidgetTester tester) async {
    ...
    testWidgets('dark theme defines TextTheme from AppTypography', (WidgetTester tester) async {
    ...
    testWidgets('themes are configured for components', (WidgetTester tester) async {
